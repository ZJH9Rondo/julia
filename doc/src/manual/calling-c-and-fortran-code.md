...
Here is a slightly more complex example that discovers the local machine's hostname from a hypothetical
networking library named "libc" (in practice, this function is usually part of the C standard library, and
the "libc" portion would be omitted, but we wish to show here the usage of this syntax):
